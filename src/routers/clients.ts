...
router.post("/", verifyAuthentication, uploadProfile.fields([{ name: "profileImage", maxCount: 1 }]), createClient_UserValidation, validationMiddleware, clientController.createClient);
